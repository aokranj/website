...
CREATE TABLE `ao_vzponi` (
  ...
  `vrsta` varchar(4) DEFAULT NULL,
  `visina_smer` varchar(15) DEFAULT NULL,
  `visina_izstop` varchar(15) DEFAULT NULL,
  ...
  `opomba` varchar(500) DEFAULT NULL,
  `slap` int(1) unsigned DEFAULT NULL,
