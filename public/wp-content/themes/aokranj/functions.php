...
require( AOKRANJ_ROOTDIR . '/inc/setup.php' );
require( AOKRANJ_ROOTDIR . '/inc/customizer.php' );
require( AOKRANJ_ROOTDIR . '/inc/scripts.php' );
require( AOKRANJ_ROOTDIR . '/inc/slider.php' );
require( AOKRANJ_ROOTDIR . '/inc/news.php' );
require( AOKRANJ_ROOTDIR . '/inc/stacks.php' );
require( AOKRANJ_ROOTDIR . '/inc/loop.php' );
